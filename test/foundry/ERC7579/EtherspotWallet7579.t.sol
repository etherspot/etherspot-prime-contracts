...
import {IAccountConfig, IAccountConfig_Hook, IEtherspotWallet7579, IExecution} from "../../../src/ERC7579/interfaces/IEtherspotWallet7579.sol";
...
contract EtherspotWallet7579Test is BootstrapUtil, Test {
    ...
    function test_AccountFeatureDetectionExecutors() public {
        assertTrue(
            account.supportsInterface(type(IEtherspotWallet7579).interfaceId)
        );
    }
