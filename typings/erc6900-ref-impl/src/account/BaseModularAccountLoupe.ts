...
export interface BaseModularAccountLoupeInterface extends utils.Interface {
  functions: {
...
export interface BaseModularAccountLoupe extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseModularAccountLoupeInterface;
