...
import type {
  BasePlugin,
  BasePluginInterface,
} from "../../../../erc6900-ref-impl/src/plugins/BasePlugin";
...
export class BasePlugin__factory {
  ...
  static createInterface(): BasePluginInterface {
    return new utils.Interface(_abi) as BasePluginInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BasePlugin {
    return new Contract(address, _abi, signerOrProvider) as BasePlugin;
  }
}
