...
export interface EntryPointSimulationsPatchInterface extends utils.Interface {
  functions: {
...
export interface EntryPointSimulationsPatch extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EntryPointSimulationsPatchInterface;
  ...
  functions: {
    ...
    init(
      entrypointAddr: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
