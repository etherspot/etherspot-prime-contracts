...
export interface IERC7579AccountInterface extends utils.Interface {
  functions: {
...
export interface IERC7579Account extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC7579AccountInterface;
