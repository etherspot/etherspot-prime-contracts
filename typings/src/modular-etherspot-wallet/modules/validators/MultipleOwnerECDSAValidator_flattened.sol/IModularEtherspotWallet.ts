...
export interface IModularEtherspotWalletInterface extends utils.Interface {
  functions: {
...
export interface IModularEtherspotWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IModularEtherspotWalletInterface;
