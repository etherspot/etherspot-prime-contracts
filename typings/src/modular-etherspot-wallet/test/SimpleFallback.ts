...
export interface SimpleFallbackInterface extends utils.Interface {
  functions: {
    ...
    "performFallbackCall(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "performFallbackCall",
    values: [PromiseOrValue<string>]
  ): string;
...
export interface SimpleFallback extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleFallbackInterface;
