...
export interface SingleOwnerPluginInterface extends utils.Interface {
  functions: {
...
export interface SingleOwnerPlugin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SingleOwnerPluginInterface;
