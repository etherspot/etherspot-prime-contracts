...
import {ManifestExecutionHook, ManifestFunction, ManifestAssociatedFunctionType, ManifestAssociatedFunction, PluginManifest, ManifestExecutionFunction} from "../../../interfaces/IPlugin.sol";
...
contract ComprehensivePlugin is BasePlugin {
        ...
        returns (PluginManifest memory)
    {
        ...
        ManifestFunction
            memory fooRuntimeValidationFunction = ManifestFunction({
                functionType: ManifestAssociatedFunctionType.SELF,
        ...
        manifest.permittedCallHooks[0] = ManifestExecutionHook({
            ...
            postExecHook: ManifestFunction({
                functionType: ManifestAssociatedFunctionType.SELF,
                functionId: uint8(
                    FunctionId.POST_PERMITTED_CALL_EXECUTION_HOOK
                ),
                dependencyIndex: 0 // Unused.
            })
        });
