    ...
    PersonalAccountRegistry // TODO: check what interaction should take place here - issue with col version compat
{
        ...
        external
    {
        ...
        require(
            ...
            "EtherspotAccount:: executeBatch - wrong array lengths"
        );
    ...
    function _initialize(address anOwner) internal virtual {
        owner = anOwner;
        emit EtherspotInitialized(_entryPoint, owner);
    }
    ...
    function _requireFromEntryPointOrOwner() internal view {
        require(
            ...
            "EtherspotAccount:: Not Owner or EntryPoint"
        );
    }
    ...
    function _validateAndUpdateNonce(UserOperation calldata userOp)
        ...
        override
    {
        require(_nonce++ == userOp.nonce, "EtherspotAccount:: Invalid nonce");
    }
