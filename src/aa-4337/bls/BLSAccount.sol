 ...
 * Note that unlike the "standard" EtherspotWallet, this account can't be called directly
 * (normal EtherspotWallet uses its "signer" address as both the ecrecover signer, and as a legitimate
 * Ethereum sender address. Obviously, a BLS public key is not a valid Ethereum sender address.)
 */
contract BLSAccount is EtherspotWallet, IBLSAccount {
