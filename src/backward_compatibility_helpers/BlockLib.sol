...
library BlockLib {
     ...
     */
    function verifyAtCurrentBlock(BlockRelated memory self)
        internal
        view
        returns (bool)
    {
     ...
     * @return true on correct self struct
     */
    function verifyAtAnyBlock(BlockRelated memory self)
        internal
        pure
        returns (bool)
    {
     ...
     * @return true on correct self struct
     */
    function verifyAtBlock(BlockRelated memory self, uint256 blockNumber)
        internal
        pure
        returns (bool)
    {
